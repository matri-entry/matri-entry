      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50 hover:bg-slate-50">
            ...
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide hidden md:table-cell">
              Mobile
            </TableHead>
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide text-center">
              Assigned
            </TableHead>
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide text-center hidden lg:table-cell">
              Done
            </TableHead>
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide text-center hidden lg:table-cell">
              Pending
            </TableHead>
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide hidden xl:table-cell">
              First Login
            </TableHead>
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide hidden xl:table-cell">
              Expiry
            ...
            <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wide text-right">
              Actions
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {users.map((user) => (
            ...
            >
              ...
              <TableCell className="text-center text-sm text-emerald-600 font-medium hidden lg:table-cell">
                {user.completedCount}
              </TableCell>
              <TableCell className="text-center text-sm text-amber-600 font-medium hidden lg:table-cell">
                {user.pendingCount}
              </TableCell>
              ...
              <TableCell className="hidden xl:table-cell">
                <span
                  className={`text-xs font-medium ${user.isExpired ? "text-rose-500" : "text-slate-500"}`}
                >
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48 rounded-xl">
                    ...
                    >
                      <Power
                        className={`w-3.5 h-3.5 ${user.isActive ? "text-slate-500" : "text-emerald-500"}`}
                      />
